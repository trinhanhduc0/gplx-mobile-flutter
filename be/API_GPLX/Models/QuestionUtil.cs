...
namespace DemoGPLX.Models
{
    public static class QuestionUtil
    {
        ...
        public static List<CCau> GetTest(int id)
        {
            return CreateNewTest(id).Select(c => new CCau
            {
                IdChuong = c.IdChuong,
                Ttcaus = new CTtcau
                {
        ...
        public static CHang GetHangFromId(int id)
        {
            return (CHang)GetAllHang().Where(e => e.IdHang == id).Select(e => new CHang
            {
                IdHang = e.IdHang,
                Thongtin = e.Thongtin,
                Diemtoida = e.Diemtoida,
                Diemtoitheu = e.Diemtoitheu,
                Thoigianthi = e.Thoigianthi,
                Thongtinchitiet = e.Thongtinchitiet,
            });
        }
    }
}
